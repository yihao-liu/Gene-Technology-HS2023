...
class LSTMSoftmaxClassifier(SoftmaxClassifier[ModelConfig]):
    def __init__(
        self,
        num_classes: int,
        ...
        self.output_fc = nn.Linear(
            model_config.dense_hidden_dim + _EXTRA_INPUTS_DIM,
            num_classes,
        )
...
if __name__ == "__main__":
    train_softmax_classifier(LSTMSoftmaxClassifier, ModelConfig)
