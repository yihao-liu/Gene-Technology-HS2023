...
class LSTMCONVSoftmaxClassifier(SoftmaxClassifier[ModelConfig]):
    def __init__(
        self,
        num_classes: int,
    ...
    def forward(
        ...
        x1, _ = self.lstm(out_embed)
        x2, _ = self.lstm2(x1)
        x3 = self.conv1d(x2.permute(0, 2, 1)).permute(0, 2, 1)
...
if __name__ == "__main__":
    train_softmax_classifier(LSTMCONVSoftmaxClassifier, ModelConfig)
